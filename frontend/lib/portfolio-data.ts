...
export const PORTFOLIO_DATA: PortfolioData = {
  developer: {
    ...
    status: 'Open for AI Engineering & Quantitative Systems Roles',
    stats: [
      { label: 'Publications', value: '3 Papers (Elsevier & Springer)' },
      { label: 'M.Tech CGPA', value: '8.06 (Somaiya University)' },
      { label: 'Swarm Roles', value: '10+ Specialized Agents' },
      { label: 'Voice Latency', value: '<500ms WebRTC' },
    ],
    socials: {
  ...
  skillCategories: [
    {
      ...
      skills: [
        ...
        { name: 'Explainable AI', level: 'Expert' },
        { name: 'Retrieval-Augmented Generation', level: 'Expert' },
    ...
    },
    {
      ...
      skills: [
        { name: 'Quantitative Finance', level: 'Expert' },
        { name: 'Portfolio Optimization', level: 'Expert' },
        { name: 'CVaR', level: 'Expert' },
        { name: 'Drawdown & Volatility', level: 'Advanced' },
        { name: 'RSI, MACD & Bollinger Bands', level: 'Expert' },
        { name: 'Market Regime Detection', level: 'Advanced' },
        { name: 'Compliance-Aware AI', level: 'Expert' },
      ],
    },
    {
      ...
      skills: [
        ...
        { name: 'Groq', level: 'Expert' },
        { name: 'Ollama & Mistral-7B', level: 'Advanced' },
        { name: 'Agent Memory', level: 'Expert' },
        { name: 'Verification Frameworks', level: 'Expert' },
        { name: 'Audit Logging', level: 'Expert' },
        { name: 'Source Grounding', level: 'Expert' },
      ],
    },
    {
      category: 'Voice AI & Real-Time Systems',
      skills: [
        { name: 'LiveKit', level: 'Expert' },
        { name: 'WebRTC', level: 'Advanced' },
        { name: 'Deepgram (STT)', level: 'Expert' },
        { name: 'ElevenLabs (TTS)', level: 'Expert' },
        { name: 'Real-Time Data Channels', level: 'Expert' },
        { name: 'Sub-500ms Conversational Pipelines', level: 'Expert' },
      ],
    },
    {
      category: 'Optimization & Graph Tools',
      skills: [
        { name: 'CVXPY', level: 'Expert' },
        { name: 'CLARABEL', level: 'Expert' },
        { name: 'NetworkX', level: 'Advanced' },
        { name: 'Risk-Aware Portfolio Construction', level: 'Expert' },
        { name: 'Graph-Based Reasoning', level: 'Advanced' },
      ],
    },
    {
      ...
      skills: [
        ...
        { name: 'NumPy, Pandas & SciPy', level: 'Expert' },
    ...
    },
    {
      ...
      skills: [
        ...
        { name: 'Gradio', level: 'Advanced' },
        { name: 'AQICN API', level: 'Advanced' },
      ],
    },
  ],
  experience: [
