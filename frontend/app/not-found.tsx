    ...
    <div className="min-h-screen w-full flex flex-col items-center justify-center bg-black text-white px-4 relative overflow-hidden select-none">
      ...
      <div className="not-found-tv-wrapper relative flex flex-col items-center justify-center">
        <style>{`
          ...
          .not-found-tv-wrapper .text_4041,
          .not-found-tv-wrapper .text_4042,
          .not-found-tv-wrapper .text_4043 {
            transform: scaleY(20) scaleX(7);
            font-weight: 900;
          }

          .not-found-tv-wrapper .main_wrapper {
            display: flex;
            align-items: center;
            justify-content: center;
            width: 28em;
          ...
          .not-found-tv-wrapper .antenna_shadow {
            position: absolute;
          ...
          .not-found-tv-wrapper .antenna::after {
            content: "";
            position: absolute;
            margin-top: -9.4em;
            margin-left: 0.4em;
          ...
          .not-found-tv-wrapper .antenna::before {
            content: "";
            position: absolute;
            margin-top: 0.2em;
            margin-left: 1.25em;
          ...
          .not-found-tv-wrapper .curve_svg {
            position: absolute;
            margin-top: 0.25em;
            margin-left: -0.25em;
            height: 12px;
          ...
          .not-found-tv-wrapper .display_div {
            display: flex;
            align-items: center;
            align-self: center;
            justify-content: center;
          ...
          .not-found-tv-wrapper .screen_out {
            width: auto;
            height: auto;
            border-radius: 10px;
          }

          .not-found-tv-wrapper .screen_out1 {
            width: 11em;
            height: 7.75em;
            display: flex;
            align-items: center;
          ...
          .not-found-tv-wrapper .screenM:before,
          .not-found-tv-wrapper .screenM:after {
            content: "";
            position: absolute;
            left: 0;
            z-index: 1;
          ...
          .not-found-tv-wrapper .notfound_text {
          ...
          .not-found-tv-wrapper .lines {
            display: flex;
            column-gap: 0.1em;
            align-self: flex-end;
          }

          .not-found-tv-wrapper .line1,
          .not-found-tv-wrapper .line3 {
            width: 2px;
            height: 0.5em;
            background-color: black;
          ...
          .not-found-tv-wrapper .buttons_div {
            width: 4.25em;
            align-self: center;
            height: 8em;
          ...
          .not-found-tv-wrapper .b1,
          .not-found-tv-wrapper .b2 {
            width: 1.65em;
            height: 1.65em;
            border-radius: 50%;
          ...
          .not-found-tv-wrapper .b1::before {
            content: "";
            position: absolute;
            margin-top: 1em;
            margin-left: 0.5em;
          ...
          .not-found-tv-wrapper .b2::before {
            content: "";
            position: absolute;
            margin-top: 1.05em;
            margin-left: 0.8em;
          ...
          .not-found-tv-wrapper .speakers {
            display: flex;
            flex-direction: column;
            row-gap: 0.5em;
          }

          .not-found-tv-wrapper .speakers .g1 {
            display: flex;
            column-gap: 0.25em;
          }

          .not-found-tv-wrapper .speakers .g11,
          .not-found-tv-wrapper .speakers .g12,
          .not-found-tv-wrapper .speakers .g13 {
            width: 0.65em;
            height: 0.65em;
            border-radius: 50%;
            background-color: #7f5934;
          ...
          .not-found-tv-wrapper .speakers .g {
            width: auto;
            height: 2px;
            background-color: #171717;
          }

          .not-found-tv-wrapper .bottom {
            width: 100%;
            height: auto;
            display: flex;
            align-items: center;
          ...
          .not-found-tv-wrapper .base1,
          .not-found-tv-wrapper .base2 {
            height: 1em;
            width: 2em;
