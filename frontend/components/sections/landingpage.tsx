      ...
      >
        ...
        <div className="z-10 mx-auto flex w-full max-w-7xl flex-col items-center justify-between gap-8 px-6 pt-20 pb-8 sm:px-12 sm:pt-24 sm:pb-10 md:px-16 lg:flex-row lg:gap-12 lg:px-20">
          <div className="flex max-w-2xl flex-col items-start space-y-4 text-left lg:max-w-2xl">
            ...
            >
              Engineering decentralized robotic swarms, multi-agent coordination protocols, and
              mathematical convex solvers built to perceive, navigate, and execute high-stakes
              decisions with zero hallucination.
            </TypingAnimation>
          ...
          <div className="relative flex flex-col items-start justify-center overflow-hidden rounded-3xl px-4 py-6 text-left sm:px-6 lg:col-span-8">
            ...
            <div className="relative z-10 space-y-5">
              ...
              <p className="text-base leading-relaxed text-slate-800 sm:text-lg sm:leading-[1.8] dark:text-neutral-200">
                I am an M.Tech Artificial Intelligence &amp; Data Science researcher at{' '}
                <strong className="text-slate-950 dark:text-white">
                  K J Somaiya College of Engineering (Somaiya Vidyavihar University, Mumbai)
                </strong>
                . My work focuses on bridging autonomous agentic swarms with convex mathematical
                optimization for high-stakes decision domains.
              </p>
