...
function Calendar({
  ...
  const cnClassNames = classNames as Record<string, string | undefined> | undefined;
  const mergedClassNames: Record<string, string> = Object.entries(defaultClassNames).reduce(
    (acc, [key, defaultValue]) => ({
      ...acc,
      [key]: cnClassNames?.[key] ? cn(defaultValue, cnClassNames[key]) : defaultValue,
    }),
