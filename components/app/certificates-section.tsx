...
export function CertificatesSection() {
  return (
    <section className="relative py-16 sm:py-24 overflow-hidden" id="certificates">
      {/* Header */}
      <div className="max-w-7xl mx-auto px-6 sm:px-12 md:px-16 lg:px-20 mb-6 flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
