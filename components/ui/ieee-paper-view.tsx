      ...
      >
        ...
        <section id="sec-math" className="mb-12 scroll-mt-24">
          ...
          <div className="text-sm sm:text-base leading-relaxed text-slate-800 dark:text-neutral-300 space-y-4 text-justify">
            ...
            <p>
              <FormattedLatexText text="where $\mathcal{L}_{\text{network}}$ captures graph topology invariants, penalizing vulnerability spillovers and enforcing conservation bounds." />
            </p>
          </div>
        </section>
        ...
        <section id="sec-eval" className="mb-12 scroll-mt-24">
          ...
          <div className="text-sm sm:text-base leading-relaxed text-slate-800 dark:text-neutral-300 space-y-6 text-justify">
            <p>
              Empirical validation was performed across extensive out-of-sample test periods. Performance
              indicators across critical operational dimensions are summarized in Table I.
            </p>
